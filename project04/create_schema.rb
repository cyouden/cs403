...
create_commands = [
  ...
  "CREATE TABLE wines (id INTEGER PRIMARY KEY, sku TEXT UNIQUE, name TEXT, purchase_date TEXT, drunk_date TEXT, rating INTEGER, comment TEXT, price REAL, vintage INTEGER, winery_id INTEGER, FOREIGN KEY(winery_id) REFERENCES wineries(id));",
